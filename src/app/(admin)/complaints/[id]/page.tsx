...
const complaintDetails: Record<string, ComplaintDetail> = {
  '1': {
    ...
    date: '2024-03-15',
    description:
      'I ordered a bamboo toothbrush set but received a damaged package. The items inside were broken and unusable.',
    chatLogs: [
      {
        id: '1',
        sender: 'Sarah Johnson',
        message:
          'Hello, I received my order but it was damaged during shipping.',
      ...
      },
      {
        ...
        sender: 'Support Team',
        message:
          'We apologize for the inconvenience. Could you please share photos of the damaged items?',
      ...
      },
      {
        ...
        sender: 'Sarah Johnson',
        message:
          "I've uploaded the photos. As you can see, the packaging was torn and items are broken.",
  ...
  '2': {
    ...
    date: '2024-03-14',
    description:
      'I completed several eco-friendly activities but my points were not credited to my account.',
    chatLogs: [
      {
        id: '1',
        sender: 'Mike Chen',
      ...
      },
      {
        ...
        sender: 'Support Team',
        message:
          "We're looking into this issue. Please provide your account details.",
  ...
  '3': {
    ...
    date: '2024-03-13',
    description:
      "My order was supposed to arrive on March 10th but it's still not here.",
    chatLogs: [
      {
        id: '1',
        sender: 'Emma Wilson',
      ...
      },
      {
        ...
        sender: 'Support Team',
        message:
          "We've checked and your order is in transit. Expected delivery: March 16th.",
  ...
  '4': {
    ...
    date: '2024-03-12',
    description:
      'I ordered a reusable water bottle but received a different product instead.',
    chatLogs: [
      {
        id: '1',
        sender: 'David Brown',
      ...
      },
      {
        ...
        sender: 'Support Team',
        message:
          "We apologize for the error. We'll send the correct item and arrange return pickup.",
